...
function numberOfCharacters(string) {
  ...
  //Escribe tu código aquí
   ...
   for(var i = 0; i < string.length;i++) {
    if (newCharacters.hasOwnProperty(string[i])) {
      newCharacters[string[i]]++;
    }
    else {
      newCharacters[string[i]] = 1;
    }
   }
...
function buscoInterseccion(arreglo1, arreglo2){
  ...
  for (let elem1 of arreglo1){
    for (let elem2 of arreglo2){
      if ( elem1 === elem2) {
